...
public class ClientRun {
	...
	public static void main(String[] args) {
		try {
			...
			DatagramPacket reciveData = new DatagramPacket(data, data.length);
			socket.receive(reciveData);
			
			String receive = new String(reciveData.getData(), 0, reciveData.getLength());
