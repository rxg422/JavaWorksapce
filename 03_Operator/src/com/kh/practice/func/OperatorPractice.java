...
public class OperatorPractice {
	...
	public void practice2() {
		...
		System.out.printf("%d학년 %d반 %d번 %s %c학생의 성적은 %.2f이다.", grade, classes, num, name, gender=='M'? '남': '여', score);
	}
	...
	public void practice4() {
		...
		System.out.println(avg >= 60.0f && kor>=40.0f && eng>=40.0f && mat>=40.0f ? "합격" : "불합격");
	}
	
	public void practice5() {
		System.out.print("주민번호를 입력하세요(-포함) : ");
		String id = sc.next();
		System.out.println(id.charAt(7)=='1'||id.charAt(7)=='3' ? "남자" : "여자");
	}
